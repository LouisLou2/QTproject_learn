...
#include <memory>
#include "../../Client/selfinfowidget.h"
...
namespace {
struct qt_meta_stringdata_SelfInfoWidget_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SelfInfoWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SelfInfoWidget_t qt_meta_stringdata_SelfInfoWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SelfInfoWidget[] = {
...
Q_CONSTINIT const QMetaObject SelfInfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_SelfInfoWidget.offsetsAndSizes,
    qt_meta_data_SelfInfoWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SelfInfoWidget_t,
        // Q_OBJECT / Q_GADGET
...
void *SelfInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelfInfoWidget.stringdata0))
