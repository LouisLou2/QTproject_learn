...
#include <memory>
#include "../../Client/Rewriting/frienditem.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FriendItem_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FriendItem_t qt_meta_stringdata_FriendItem = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_FriendItem[] = {
...
Q_CONSTINIT const QMetaObject FriendItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_FriendItem.offsetsAndSizes,
    qt_meta_data_FriendItem,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_FriendItem_t,
        // Q_OBJECT / Q_GADGET
