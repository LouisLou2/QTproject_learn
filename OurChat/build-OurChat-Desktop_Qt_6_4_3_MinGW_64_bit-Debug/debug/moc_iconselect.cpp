...
#include <memory>
#include "../../Client/IconSetting/iconselect.h"
...
namespace {
struct qt_meta_stringdata_IconSelect_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_IconSelect_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_IconSelect_t qt_meta_stringdata_IconSelect = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_IconSelect[] = {
...
Q_CONSTINIT const QMetaObject IconSelect::staticMetaObject = { {
    ...
    qt_meta_stringdata_IconSelect.offsetsAndSizes,
    qt_meta_data_IconSelect,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_IconSelect_t,
        // Q_OBJECT / Q_GADGET
...
void *IconSelect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IconSelect.stringdata0))
