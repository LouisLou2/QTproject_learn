...
#include <memory>
#include "../../Client/Rewriting/smoothscrolllistwidget.h"
...
namespace {
struct qt_meta_stringdata_SmoothScrollListWidget_t {
    uint offsetsAndSizes[2];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SmoothScrollListWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SmoothScrollListWidget_t qt_meta_stringdata_SmoothScrollListWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SmoothScrollListWidget[] = {
...
Q_CONSTINIT const QMetaObject SmoothScrollListWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_SmoothScrollListWidget.offsetsAndSizes,
    qt_meta_data_SmoothScrollListWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SmoothScrollListWidget_t,
        // Q_OBJECT / Q_GADGET
...
void *SmoothScrollListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SmoothScrollListWidget.stringdata0))
