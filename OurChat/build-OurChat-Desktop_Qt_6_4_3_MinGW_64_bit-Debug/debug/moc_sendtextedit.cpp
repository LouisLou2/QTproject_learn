...
#include <memory>
#include "../../Client/Rewriting/sendtextedit.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SendTextEdit_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SendTextEdit_t qt_meta_stringdata_SendTextEdit = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SendTextEdit[] = {
...
Q_CONSTINIT const QMetaObject SendTextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_SendTextEdit.offsetsAndSizes,
    qt_meta_data_SendTextEdit,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SendTextEdit_t,
        // Q_OBJECT / Q_GADGET
