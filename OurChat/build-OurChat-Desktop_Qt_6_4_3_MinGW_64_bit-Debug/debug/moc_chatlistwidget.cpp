...
#include <memory>
#include "../../Client/Chatting/chatlistwidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ChatListWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ChatListWidget_t qt_meta_stringdata_ChatListWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ChatListWidget[] = {
...
Q_CONSTINIT const QMetaObject ChatListWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ChatListWidget.offsetsAndSizes,
    qt_meta_data_ChatListWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ChatListWidget_t,
        // Q_OBJECT / Q_GADGET
